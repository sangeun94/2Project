...
<body>
    ...
    <main id="content" class="loginContent">
        <div class="selectBox">
            <div class="memberBox" onclick="location.href='../Patient/Login1.jsp';">
                회원 로그인
            </div>
        ...
        <div class="logBoxWrap">
            <div class="logBox">
                ...
                <p class="colorPoint02">휴먼대학교병원 관리페이지 회원 서비스는<br>로그인 후 이용하실 수 있습니다.</p>
                <form id="memberVo" action="adminLogin_proc.jsp" method="post">
                    <label><input id="id" name="employee_number" placeholder="아이디 (임직원번호)" class="inputText" type="text" value=""></label>                           
                    <label><input id="pass" name="password" onkeydown="check();" placeholder="비밀번호" class="inputText" type="password" value=""></label>
