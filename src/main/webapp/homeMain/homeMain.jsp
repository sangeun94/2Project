<%@ include file="./home_layout/header.jsp" %>
       ...
       <!-- 슬라이더 시작 -->
        <div class="image-container_top">
            ...
            <div class="top_img_wrapper">
                ...
                <div class="img">
                    <img src="./imgs/상단1.jpg" alt="사진 1">
                </div>

                <div class="img">
                    <img src="./imgs/상단2.jpg" alt="사진 2">
                </div>

                <div class="img">
                    <img src="./imgs/상단3.jpg" alt="사진 3">
                </div>

                <div class="img">
                    <img src="./imgs/상단4.jpg" alt="사진 4">
                </div>

                <div class="img">
                    <img src="./imgs/상단5.jpg" alt="사진 5">
                </div>

                <div class="img">
                    <img src="./imgs/상단6.jpg" alt="사진 6">
                </div>

                <div class="img">
                    <img src="./imgs/상단7.jpg" alt="사진 7">
                </div>
        ...
        <script src="../js/swiperbtn.js"></script>
        <!-- 슬라이더 끝 -->
        ...
        <div class="middleBody">
            ...
            <div class="mainInner">
                ...
                <div class="mainInner_Row">
                    ...
                    <div class="mainCol01 mainLoginWrap">
                        <h3 class="m_L_h">로그인</h3>
                        <div class="btnWrap">
                ...
                <div class="mainInner_Row">
                    ...
                    <div class="mainCol02 mainSearchWrap">
                        <img src="./imgs/자료1.jpg">
                        <h3 class="m02_T_h">의료진 찾기</h3>
                        <p class="m02_a_p">
                            서울대학교병원의 의료진은
                            <br>
                            환자를 위해 항상 노력하고 있습니다.
                ...
                <div class="mainInner_Row">
                    ...
                    <div class="mainCol02 Issue">
                        <h3 class="m02_T_h_b">SNUH 핫이슈</h3>
                    </div>
...
<%@ include file="./home_layout/footer.jsp" %>